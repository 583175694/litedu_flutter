/**
 * @ClassName custom_underline_tab_indicator
 * @Author wushaohang
 * @Date 2020/6/7
 **/
...
class _UnderlinePainter extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    var rrect = RRect.fromLTRBAndCorners(indicator.bottomLeft.dx, indicator.bottomRight.dy, indicator.bottomRight.dx, indicator.bottomRight.dy + borderSide.width,
