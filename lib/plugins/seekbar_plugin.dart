...
class _SeekBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawIndicator() {
      ...
      canvas.drawImage(image, Offset(value * size.width - ScreenUtil().setWidth(image.width.toDouble()), size.height - ScreenUtil().setWidth(image.height.toDouble())), indicatorPaint);
